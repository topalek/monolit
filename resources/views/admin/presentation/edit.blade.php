...
{!! Form::model($presentation, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array(config('quickadmin.route').'.presentation.update', $presentation->id))) !!}
